...
class StoreSliderRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'external_url' => 'nullable|required_if:link_type,external|url|max:255',
            'linkable_type' => 'nullable|required_if:link_type,internal|string|max:255',
            'linkable_id' => 'nullable|required_if:link_type,internal|integer',
    ...
    public function messages(): array
    {
        return [
            ...
            'image_path.required' => 'La imagen principal es obligatoria.',
            ...
            'external_url.required_if' => 'La URL externa es obligatoria cuando el enlace es externo.',
