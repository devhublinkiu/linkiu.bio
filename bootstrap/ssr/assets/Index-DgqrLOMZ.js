...
import { P as PublicLayout$1 } from "./PublicLayout-C1n6GEnS.js";
...
function Index({ tenant, locations, selected_location_id = null }) {
  ...
  const verticalSlug = currentTenant?.vertical?.slug ?? null;
  ...
  const Layout = isChurch ? PublicLayout : PublicLayout$1;
  return /* @__PURE__ */ jsxs(Layout, { bgColor: bg_color, children: [
    /* @__PURE__ */ jsx(Head, { title: `Nuestras Sedes - ${tenant.name}` }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-col min-h-screen pb-20", children: /* @__PURE__ */ jsxs("div", { className: "max-w-md mx-auto px-4 w-full", children: [
