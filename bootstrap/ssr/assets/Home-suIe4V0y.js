    ...
    PublicLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-gray-50 p-4 -mt-4 relative z-0 pb-20 flex flex-col gap-6", children: [
          ...
          Array.isArray(promo_shorts) && promo_shorts.length > 0 && /* @__PURE__ */ jsxs("section", { className: "w-full px-4", "aria-labelledby": "shorts-heading", children: [
            /* @__PURE__ */ jsx("h2", { id: "shorts-heading", className: "mb-3 text-lg font-bold text-slate-900", children: "Shorts" }),
