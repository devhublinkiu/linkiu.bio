...
import { P as PublicLayout } from "./PublicLayout-ksD2YDE4.js";
    ...
    PublicLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-gray-50 p-4 -mt-4 relative z-0 pb-20 flex flex-col gap-6", children: [
          ...
          Array.isArray(promo_shorts) && promo_shorts.length > 0 && /* @__PURE__ */ jsxs("section", { className: "w-full max-w-[100vw]", "aria-labelledby": "shorts-heading", children: [
            /* @__PURE__ */ jsx("h2", { id: "shorts-heading", className: "text-[100px] font-black text-gray-200 px-4 flex items-center -mb-16", children: "Shorts" }),
            /* @__PURE__ */ jsx(
              Carousel,
              {
