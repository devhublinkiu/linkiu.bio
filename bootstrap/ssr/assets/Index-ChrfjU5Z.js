...
import { P as PublicLayout } from "./PublicLayout-ByoYHI1W.js";
import { P as ProductCard } from "./ProductCard-Dv7jum-6.js";
...
function FavoritesIndex({ tenant }) {
  ...
  const brandColors = tenant.brand_colors ?? { bg_color: "#f8fafc", name_color: "#1e293b" };
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { bgColor: bg_color, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col min-h-screen", children: [
      /* @__PURE__ */ jsxs("div", { className: "px-4 pt-6 pb-2", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "p-4 pb-32 flex-1", children: loading ? /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-20", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "bg-rose-50 p-6 rounded-full shadow-sm mb-4", children: /* @__PURE__ */ jsx(Heart, { className: "size-10 text-red-500 fill-current animate-pulse" }) }),
