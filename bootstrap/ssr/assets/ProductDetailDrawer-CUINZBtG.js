...
import { i as isBrowser, n as noop } from "./util-Dl4_fw_3.js";
import { jsx, jsxs, Fragment } from "react/jsx-runtime";
import { S as Sheet, b as SheetContent, d as SheetTitle, e as SheetDescription } from "./sheet-BFMMArVC.js";
import { B as Button } from "./button-BdX_X5dq.js";
import { u as useCart } from "./PublicLayout-Cmc7eheT.js";
...
function ProductDetailDrawer({ product, isOpen, onClose }) {
  ...
  return /* @__PURE__ */ jsx(Sheet, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxs(
    SheetContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(SheetTitle, { className: "sr-only", children: product.name }),
        /* @__PURE__ */ jsx(SheetDescription, { className: "sr-only", children: product.short_description || `Detalle y opciones de ${product.name}` }),
