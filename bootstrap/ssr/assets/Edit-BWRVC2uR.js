...
function Edit({ testimonial }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Editar testimonio", children: [
    /* @__PURE__ */ jsx(Head, { title: "Editar testimonio" }),
    /* @__PURE__ */ jsx("div", { className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6 rounded-xl border bg-card p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Sube una nueva para reemplazar la actual." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "image_file",
          ...
          (imagePreview || currentImageUrl) && /* @__PURE__ */ jsx("div", { className: "w-40 h-24 rounded-lg border overflow-hidden bg-muted", children: /* @__PURE__ */ jsx(
            "img",
            {
