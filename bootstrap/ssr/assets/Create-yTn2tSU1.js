...
import { S as SuperAdminLayout } from "./SuperAdminLayout-BG5OlR5E.js";
...
import { M as MediaInput } from "./MediaInput-4bZEBtYn.js";
import { V as VERTICAL_CONFIG, M as MODULE_HAS_LIMIT, a as MODULE_LABELS, L as LIMIT_FORM_KEY_TO_BACKEND } from "./menuConfig-yp3b8soW.js";
import "./dropdown-menu-y0DV_5RX.js";
...
function Create({ verticals }) {
  const { data, setData, post, processing, errors } = useForm({
    ...
    cover: null,
    cover_path: "",
    // Added for Media Manager
    cover_preview: null,
    features: [""]
    // Changed to any to allow objects
  });
  ...
  return /* @__PURE__ */ jsxs(SuperAdminLayout, { header: "Crear Nuevo Plan", children: [
    /* @__PURE__ */ jsx(Head, { title: "Crear Plan" }),
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-8", children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "grid gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
                ...
                /* @__PURE__ */ jsx(Input, { id: "name", value: data.name, onChange: (e) => setData("name", e.target.value), placeholder: "Ej. Plan Emprendedor", required: true }),
                /* @__PURE__ */ jsx(FieldError, { children: errors.name })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
                /* @__PURE__ */ jsx(Label, { htmlFor: "slug", children: "Slug (URL amigable)" }),
                /* @__PURE__ */ jsx(Input, { id: "slug", value: data.slug, onChange: (e) => setData("slug", e.target.value), placeholder: "plan-emprendedor", required: true }),
                /* @__PURE__ */ jsx(FieldError, { children: errors.slug })
              ] })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "description", children: "Descripción Corta" }),
              /* @__PURE__ */ jsx(Textarea, { id: "description", value: data.description, onChange: (e) => setData("description", e.target.value), placeholder: "Breve descripción que aparecerá en la tarjeta del plan." }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid md:grid-cols-3 gap-6", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxs(Card, { children: [
            ...
            /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Si se activa, el usuario inicia la prueba sin pagar." }),
              /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1.5", children: [
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { children: [
            ...
            ] }, key)) : /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-500 col-span-full", children: "Selecciona una vertical para ver los módulos disponibles." }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-4 pt-4", children: [
          ...
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, className: "min-w-[150px]", children: processing ? "Guardando..." : "Crear Plan" })
        ] })
      ] })
    ] })
  ] });
