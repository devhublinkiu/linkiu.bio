...
import { E as EpisodeCard, F as FloatingAudioPlayer } from "./FloatingAudioPlayer-gBwwS9YU.js";
    ...
    PublicLayout,
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 bg-gray-50 p-4 -mt-4 relative z-0 pb-20 flex flex-col gap-6", children: [
          ...
          services.length > 0 && /* @__PURE__ */ jsxs("section", { className: "w-full -mx-4", "aria-labelledby": "servicios-slider-heading", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-x-auto snap-x snap-mandatory flex gap-4 px-4 pb-2 scrollbar-none", children: services.map((service) => /* @__PURE__ */ jsxs(
              Link,
              {
                href: route("tenant.public.services", tenant.slug),
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "p-3 flex flex-col flex-1", children: [
                    ...
                    service.schedule && /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 mt-1 line-clamp-1", children: service.schedule })
                  ] })
                ]
              },
              service.id
              ...
              children: /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2", children: [
                      ...
                      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 shrink-0", children: /* @__PURE__ */ jsxs("span", { className: "px-5 py-2.5 rounded-xl bg-white text-slate-800 font-bold text-sm shadow-md group-hover:bg-white/95 group-hover:shadow-lg transition-all inline-flex items-center gap-2", children: [
                        "Pedir cita",
          ...
          devotionals.length > 0 && /* @__PURE__ */ jsxs("section", { className: "w-full -mx-4", "aria-labelledby": "devocionales-slider-heading", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 mb-3", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "overflow-x-auto snap-x snap-mandatory flex gap-4 px-4 pb-2 scrollbar-none", children: devotionals.map((d) => /* @__PURE__ */ jsxs(
              Link,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "p-3 flex flex-col flex-1", children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-900 line-clamp-2", children: d.title }),
                    /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 mt-1", children: new Date(d.date).toLocaleDateString("es", { day: "numeric", month: "short", year: "numeric" }) }),
