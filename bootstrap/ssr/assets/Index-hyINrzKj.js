...
function ReservationIndex({ tenant, locations, bankAccounts = [] }) {
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { bgColor: bg_color, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex-1 p-4 -mt-4 relative z-0 pb-20", children: /* @__PURE__ */ jsxs(Card, { className: "w-full max-w-xl mx-auto mb-8 mt-4 border-0 shadow-sm bg-white/80 backdrop-blur-sm rounded-2xl", children: [
