...
import { P as PublicLayoutPortalContext, H as HeaderShellAll, F as FooterShellAll } from "./HeaderShellAll-dJouNd-7.js";
import { Toaster } from "sonner";
function PublicLayout({ children, bgColor, renderBottomAction, renderFloatingBottom }) {
  const [portalEl, setPortalEl] = useState(null);
  return /* @__PURE__ */ jsx(PublicLayoutPortalContext.Provider, { value: portalEl, children: /* @__PURE__ */ jsxs("div", { className: "h-dvh w-full flex justify-center items-stretch relative overflow-hidden transition-colors duration-500 bg-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[480px] h-full max-h-[100dvh] bg-white shadow-2xl overflow-hidden flex flex-col relative mx-auto z-10 transform-gpu", children: [
