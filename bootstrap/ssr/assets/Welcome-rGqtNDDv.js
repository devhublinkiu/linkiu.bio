...
import { Link, Store, User, UtensilsCrossed, MessageCircle, Briefcase, ChevronLeft, ChevronRight, Link2, TrendingUp, Menu } from "lucide-react";
...
import { S as Sheet, f as SheetTrigger, a as SheetContent } from "./sheet-DFnQxYfh.js";
...
function NosotrosSection() {
  return /* @__PURE__ */ jsxs("section", { id: "nosotros", className: "relative z-10 overflow-hidden py-16 sm:py-24", children: [
    /* @__PURE__ */ jsx(
      ...
      {
        className: cn(
          "absolute inset-0 text-slate-300/40 dark:text-slate-600/30",
    ...
    /* @__PURE__ */ jsx("div", { className: "relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs("div", { className: "grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "relative flex flex-col items-center justify-center min-h-[320px] sm:min-h-[380px]", children: [
        /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-[280px] rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/50 dark:border-slate-700 dark:bg-slate-800/80 dark:shadow-slate-900/50", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-0 w-[260px] rounded-2xl border border-slate-200 bg-white p-4 shadow-md dark:border-slate-700 dark:bg-slate-800/60 sm:right-4 sm:top-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-8 left-0 rounded-xl border border-emerald-200 bg-white px-3 py-2 shadow-sm dark:border-emerald-800 dark:bg-slate-800/80 sm:left-4", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
  ...
  return /* @__PURE__ */ jsx("footer", { className: "relative z-10 w-full border-t border-slate-200 bg-white pt-8 pb-0 dark:border-slate-800 dark:bg-slate-950 overflow-hidden sm:pt-12", children: /* @__PURE__ */ jsxs("div", { className: "relative z-10 mx-auto w-full max-w-6xl px-4 sm:px-6 lg:max-w-7xl", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-8 md:flex-row md:items-start md:justify-between md:gap-10", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-3", children: [
        /* @__PURE__ */ jsxs("h3", { className: "text-3xl font-bold pb-2 sm:text-5xl lg:text-6xl", children: [
          "Un solo enlace, ",
          /* @__PURE__ */ jsx("br", {}),
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        "aria-hidden": true,
        children: /* @__PURE__ */ jsx("span", { className: "select-none text-[clamp(10rem,45vw,48rem)] font-black leading-none tracking-tighter text-slate-100 dark:text-slate-800/50 sm:text-[clamp(20rem,20vw,48rem)]", children: "Linkiu" })
      }
    )
  ] }) });
}
