...
function Edit({ short, locations, categories, products }) {
  ...
  const { data, setData, post, processing, errors } = useForm({
    ...
    link_type: short.link_type === "none" || !["category", "product", "external"].includes(short.link_type) ? "none" : short.link_type,
    ...
    /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Deja vacío para mantener el actual. MP4 o MOV, máx. 100 MB, hasta 60 s" }),
          /* @__PURE__ */ jsx(FieldError, { children: errors.short_video })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "poster_url", children: "URL de portada (opcional)" }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "poster_url",
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Para elegir el fotograma en el vídeo, usa el panel de Bunny Stream (miniatura) y guarda; o pega aquí la URL de una imagen." }),
          /* @__PURE__ */ jsx(FieldError, { children: errors.poster_url })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
