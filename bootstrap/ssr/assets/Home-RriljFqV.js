...
import { ArrowUpRight, ArrowLeft, ArrowRight, Heart, ArrowUp, Flame, ArrowDown, Plus } from "lucide-react";
...
function ItemProductTopBestSeller({
  ...
  const verProductoInner = /* @__PURE__ */ jsx("span", { className: "block w-full max-w-[89px] text-center text-[10px] font-normal leading-3 text-slate-100", children: "Ver producto" });
  return /* @__PURE__ */ jsxs(
    "div",
    {
      className: cn(
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "relative h-[100px] w-full shrink-0 overflow-hidden rounded-t-lg bg-slate-100", children: [
          ...
          showTrend ? /* @__PURE__ */ jsxs("div", { className: "absolute bottom-1 right-1 z-10 flex items-center gap-0.5 rounded-full bg-emerald-100 px-1 py-0.5", children: [
            /* @__PURE__ */ jsx(ArrowUp, { className: "size-2 shrink-0 text-emerald-800", strokeWidth: 2, "aria-hidden": true }),
            /* @__PURE__ */ jsx("span", { className: "text-[10px] font-bold leading-none text-emerald-800", children: trendValue })
          ] }) : null
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center bg-slate-50 px-1 py-2", children: /* @__PURE__ */ jsx("p", { className: "line-clamp-2 w-full max-w-[89px] text-[10px] font-normal leading-3 text-slate-700", children: name }) }),
        verProductoHref ? /* @__PURE__ */ jsx(
          Link,
          {
            ...
            children: verProductoInner
          }
        ) : onVerProductoClick ? /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
        ...
        ) : /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center rounded-b-lg bg-slate-700 p-1", children: verProductoInner })
      ]
    }
  );
}
  ...
  return /* @__PURE__ */ jsxs("section", { className: cn("w-full", className), "aria-labelledby": "top-best-seller-heading", children: [
    ...
    /* @__PURE__ */ jsx(
      "div",
      {
        ...
        children: list.map((product) => /* @__PURE__ */ jsx(
