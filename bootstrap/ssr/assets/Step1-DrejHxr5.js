          ...
          return /* @__PURE__ */ jsxs(
            Card,
            {
              ...
              children: [
                ...
                isSelected && /* @__PURE__ */ jsx("div", { className: "absolute top-4 right-6 animate-in zoom-in duration-300", children: /* @__PURE__ */ jsx("div", { className: "h-6 w-6 bg-white rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsx(CheckCircle2, { className: "w-4 h-4 text-primary" }) }) })
              ]
            },
            vertical.id
          );
