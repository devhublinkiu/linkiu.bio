...
const LayoutContent = ({
  ...
  return /* @__PURE__ */ jsx(PublicLayoutPortalContext.Provider, { value: portalEl, children: /* @__PURE__ */ jsxs("div", { className: "flex h-dvh w-full items-stretch justify-center overflow-hidden bg-white transition-colors duration-500", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative mx-auto flex h-full max-h-[100dvh] w-full max-w-[480px] flex-col overflow-hidden bg-white shadow-2xl transform-gpu", children: [
