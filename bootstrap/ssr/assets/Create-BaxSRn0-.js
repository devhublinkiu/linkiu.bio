...
import { A as AdminLayout } from "./AdminLayout-CxiTOlRn.js";
...
import "./menuConfig-yp3b8soW.js";
import "./sonner-ZUDSQr7N.js";
import "@radix-ui/react-label";
import "@radix-ui/react-select";
function Create({ locations, categories, products, shorts_limit, shorts_count }) {
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Nuevo short", children: [
    /* @__PURE__ */ jsx(Head, { title: "Nuevo short" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-2xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-bold tracking-tight mb-6", children: "Nuevo short" }),
      atLimit ? /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: "Has alcanzado el máximo de shorts permitidos en tu plan." }) : /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx(
            Input,
            {
              ...
              placeholder: "Ej. Título del short",
              maxLength: 255
            }
          ),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { children: "Enlace (opcional)" }),
          /* @__PURE__ */ jsxs(
            Select,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Sin enlace" }) }),
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { children: "Subir short *" }),
          /* @__PURE__ */ jsx(
            Input,
            {
              type: "file",
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "MP4 o MOV, máx. 100 MB, hasta 60 s" }),
          /* @__PURE__ */ jsx(FieldError, { children: errors.short_video })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { htmlFor: "description", children: "Descripción (máx. 50 caracteres)" }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "description",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-2", children: [
          /* @__PURE__ */ jsx(Button, { type: "submit", disabled: processing, children: processing ? "Guardando…" : "Crear short" }),
