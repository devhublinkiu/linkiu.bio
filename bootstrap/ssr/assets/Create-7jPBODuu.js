...
function Create() {
  ...
  const submit = (e) => {
    ...
    router.post(route("tenant.admin.services.store", currentTenant?.slug), payload, {
      preserveScroll: true,
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Nuevo servicio", children: [
    /* @__PURE__ */ jsx(Head, { title: "Nuevo servicio" }),
    /* @__PURE__ */ jsx("div", { className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Añade un culto, reunión o actividad que ofrece tu iglesia." })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6 rounded-xl border bg-card p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Se redimensionará a 200 × 120 px. Máx. 2 MB." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "image_file",
          ...
          imagePreview && /* @__PURE__ */ jsx("div", { className: "w-[200px] h-[120px] rounded-lg border overflow-hidden bg-muted", children: /* @__PURE__ */ jsx(
            "img",
            {
              src: imagePreview,
              alt: "Vista previa",
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3 pt-2", children: [
          ...
          /* @__PURE__ */ jsx(
            Button,
            {
              type: "button",
              variant: "outline",
              onClick: () => router.visit(route("tenant.admin.services.index", currentTenant?.slug)),
              children: "Cancelar"
            }
          )
        ] })
