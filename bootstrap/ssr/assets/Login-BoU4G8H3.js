...
import { ShoppingBag, Store, Mail, Lock, EyeOff, Eye, Loader2, ArrowRight, ShieldCheck } from "lucide-react";
import "clsx";
...
function Login({ tenant, siteSettings, status }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-blue-50 via-white to-slate-50", children: [
    /* @__PURE__ */ jsx(Head, { title: `Admin Login - ${tenant.name}` }),
    /* @__PURE__ */ jsxs("div", { className: "sm:mx-auto sm:w-full sm:max-w-md", children: [
      /* @__PURE__ */ jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ jsx(Link, { href: route("tenant.home", { tenant: tenant.slug }), children: siteSettings?.logo_url ? /* @__PURE__ */ jsx(
        "img",
        {
      ...
      ) : /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 font-bold text-2xl tracking-tight text-foreground", children: [
        /* @__PURE__ */ jsx("div", { className: "h-10 w-10 flex items-center justify-center bg-primary p-2 rounded-xl shadow-lg shadow-primary/20", children: /* @__PURE__ */ jsx(ShoppingBag, { className: "h-6 w-6 text-primary-foreground" }) }),
        /* @__PURE__ */ jsx("span", { children: siteSettings?.app_name || "Linkiu.bio" })
      ] }) }) }),
      /* @__PURE__ */ jsxs("div", { className: "text-center space-y-2 mb-8", children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-gray-500 font-medium flex items-center justify-center gap-2", children: [
          /* @__PURE__ */ jsx(Store, { className: "w-4 h-4 text-primary" }),
          tenant.name
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0", children: [
      /* @__PURE__ */ jsxs(Card, { className: "border-none shadow-2xl shadow-blue-100/50 overflow-hidden bg-white/80 backdrop-blur-md", children: [
        /* @__PURE__ */ jsxs(CardHeader, { className: "space-y-1 pb-4", children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Ingresa tus credenciales para administrar tu tienda" })
        ] }),
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-sm text-gray-500", children: [
          ...
          /* @__PURE__ */ jsx(
            Link,
            {
              ...
              children: "Crea tu tienda gratis"
            }
          )
        ] }),
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center gap-4 pt-4 opacity-50 grayscale hover:grayscale-0 transition-all duration-500", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 text-xs font-bold text-gray-400 uppercase tracking-widest", children: [
