...
function Edit({ role, permissions, rolePermissions }) {
  ...
  return /* @__PURE__ */ jsxs(SuperAdminLayout, { header: `Editar Rol: ${role.name}`, children: [
    /* @__PURE__ */ jsx(Head, { title: "Editar Rol" }),
    ...
    /* @__PURE__ */ jsx("form", { onSubmit: submit, children: /* @__PURE__ */ jsxs("div", { className: "max-w-4xl mx-auto space-y-8", children: [
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          ...
          /* @__PURE__ */ jsx(CardDescription, { children: "Modifica el nombre del rol para identificarlo correctamente." })
        ] }),
