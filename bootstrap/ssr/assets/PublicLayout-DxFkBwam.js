...
import { ShoppingBag, ChevronRight, Lock, Truck, CreditCard, Headphones, MapPin } from "lucide-react";
import { AnimatePresence, motion } from "framer-motion";
import { R as ReportBusinessStrip, F as Footer } from "./ReportBusinessStrip-U20bW72V.js";
...
function PreFooter() {
  ...
  return /* @__PURE__ */ jsx("section", { className: "bg-slate-50/80 border-t border-slate-200/80 px-6 py-6 text-sm", "aria-label": "Confianza y legal", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-[480px] space-y-5", children: [
    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-4 gap-2 text-center", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
        /* @__PURE__ */ jsx("div", { className: "flex size-8 items-center justify-center rounded-lg bg-slate-200/80 text-slate-500", children: /* @__PURE__ */ jsx(Lock, { className: "size-4", "aria-hidden": true }) }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-medium text-slate-500", children: "SSL" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
        /* @__PURE__ */ jsx("div", { className: "flex size-8 items-center justify-center rounded-lg bg-slate-200/80 text-slate-500", children: /* @__PURE__ */ jsx(Truck, { className: "size-4", "aria-hidden": true }) }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-medium text-slate-500", children: "Envíos" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
        /* @__PURE__ */ jsx("div", { className: "flex size-8 items-center justify-center rounded-lg bg-slate-200/80 text-slate-500", children: /* @__PURE__ */ jsx(CreditCard, { className: "size-4", "aria-hidden": true }) }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-medium text-slate-500", children: "Pagos" })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center gap-1", children: [
        /* @__PURE__ */ jsx("div", { className: "flex size-8 items-center justify-center rounded-lg bg-slate-200/80 text-slate-500", children: /* @__PURE__ */ jsx(Headphones, { className: "size-4", "aria-hidden": true }) }),
        /* @__PURE__ */ jsx("span", { className: "text-[11px] font-medium text-slate-500", children: "Soporte" })
      ] })
    ] }),
    /* @__PURE__ */ jsx("ul", { className: "flex flex-wrap justify-center gap-x-2 gap-y-1 text-slate-500", children: LEGAL_LINKS.map((item, i) => /* @__PURE__ */ jsxs("li", { className: "flex items-center gap-x-2", children: [
      i > 0 && /* @__PURE__ */ jsx("span", { className: "text-slate-300", children: "·" }),
      /* @__PURE__ */ jsx(
        Link,
        {
...
const LayoutContent = ({ children, bgColor, renderPrefooter, renderBottomAction, showFloatingCart = true }) => {
  const cart = useCart();
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-dvh w-full flex justify-center items-stretch relative overflow-hidden transition-colors duration-500 bg-white", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full max-w-[480px] h-full max-h-[100dvh] shadow-2xl overflow-hidden flex flex-col relative mx-auto bg-white pt-32", children: [
      /* @__PURE__ */ jsxs(
        "div",
        {
      ...
      /* @__PURE__ */ jsx("div", { className: "scrollbar-public flex-1 min-h-0 relative overflow-y-auto overflow-x-hidden z-10", children: /* @__PURE__ */ jsxs("div", { className: "min-h-full flex flex-col", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex w-full shrink-0 flex-col items-end overflow-x-hidden", children: [
          /* @__PURE__ */ jsx("div", { className: "flex w-full flex-col items-center justify-center overflow-hidden pt-2 pb-1", children: /* @__PURE__ */ jsxs(ScrollVelocityContainer, { className: "text-xl font-bold leading-tight tracking-tight text-slate-950 md:text-3xl [&>div]:py-0.5", children: [
        ...
        renderPrefooter ?? /* @__PURE__ */ jsx(PreFooter, {}),
        /* @__PURE__ */ jsx(Footer, {})
      ] }) }),
