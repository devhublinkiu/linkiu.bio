...
function Create() {
  ...
  const submit = (e) => {
    ...
    router.post(route("tenant.admin.audio-dosis.store", currentTenant?.slug), payload, {
      preserveScroll: true,
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Nuevo episodio", children: [
    /* @__PURE__ */ jsx(Head, { title: "Nuevo episodio" }),
    /* @__PURE__ */ jsxs("div", { className: "max-w-xl mx-auto", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Título, archivo de audio y duración. Formatos: MP3, WAV, OGG, M4A (máx. 100 MB)." })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "mt-6 space-y-6 rounded-xl border bg-card p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsx(Label, { children: "Archivo de audio *" }),
          /* @__PURE__ */ jsx(
            "input",
            {
              ref: fileInputRef,
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx(Label, { htmlFor: "is_published", children: "Publicado (visible en la página pública)" })
        ] }),
