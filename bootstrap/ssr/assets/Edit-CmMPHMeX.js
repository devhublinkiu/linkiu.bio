...
function Edit({ collaborator }) {
  ...
  const [form, setForm] = useState({
    ...
    is_published: collaborator.is_published
  });
  const [photoPreview, setPhotoPreview] = useState(null);
  const currentPhotoUrl = collaborator.photo ?? null;
  ...
  const submit = (e) => {
    ...
    router.put(route("tenant.admin.collaborators.update", [currentTenant?.slug, collaborator.id]), payload, {
      preserveScroll: true,
      onSuccess: () => toast.success("Colaborador actualizado correctamente"),
      onError: (errs) => {
        setErrors(errs);
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Editar colaborador", children: [
    /* @__PURE__ */ jsx(Head, { title: "Editar colaborador" }),
    /* @__PURE__ */ jsx("div", { className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm mt-1", children: collaborator.name })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6 rounded-xl border bg-card p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Se usará como foto de perfil (cuadrada). Máx. 2 MB. Dejar vacío para mantener la actual." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "photo_file",
          ...
          displayPhoto && /* @__PURE__ */ jsx("div", { className: "w-24 h-24 rounded-full border overflow-hidden bg-muted", children: /* @__PURE__ */ jsx("img", { src: displayPhoto, alt: "Vista previa", className: "w-full h-full object-cover" }) }),
