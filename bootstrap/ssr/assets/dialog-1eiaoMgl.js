...
const DialogContent = React.forwardRef(({ className, children, showCloseButton = true, portalContainer, ...props }, ref) => /* @__PURE__ */ jsxs(DialogPortal, { container: portalContainer, children: [
  /* @__PURE__ */ jsx(
    DialogOverlay,
    {
