    ...
    "article",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 flex flex-col justify-center", children: [
          /* @__PURE__ */ jsx("h2", { className: `font-bold text-base line-clamp-2 ${textClass}`, children: ep.title }),
          /* @__PURE__ */ jsxs("p", { className: `text-xs flex items-center gap-2 flex-wrap mt-0.5 ${metaClass}`, children: [
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "bg-gradient-to-b from-white to-slate-200 border-t border-slate-200 shadow-xl safe-area-pb mx-4 my-6 rounded-xl", children: /* @__PURE__ */ jsxs("div", { className: "max-w-lg mx-auto px-4 py-2", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 mx-2", children: [
          /* @__PURE__ */ jsx("p", { className: "font-semibold text-slate-900 text-sm truncate", children: ep.title }),
