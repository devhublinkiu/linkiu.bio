...
import { u as useCart, P as PublicLayout } from "./PublicLayout-C1n6GEnS.js";
import { P as PromotionalTicker, B as BannerSlider, C as Carousel, a as PromoCard } from "./promo-carousel-DxUxB6OQ.js";
import { Flame, Heart, Plus, ChevronLeft, ChevronRight } from "lucide-react";
import { u as useFavorites, P as ProductDetailDrawer } from "./ProductDetailDrawer-4t9BzSaz.js";
import { f as formatPrice } from "./utils-B0hQsrDj.js";
import "sonner";
import "framer-motion";
import "./HeaderShellAll-1-HGtoe6.js";
...
function Home({
  ...
  brandColors.name_color ?? "#ffffff";
  brandColors.description_color;
  ...
  return /* @__PURE__ */ jsxs(PublicLayout, { bgColor: bg_color, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex flex-col", children: /* @__PURE__ */ jsx(PromotionalTicker, { tickers }) }),
    /* @__PURE__ */ jsxs("div", { className: "flex-1 min-w-0 p-4 -mt-4 relative z-0 pb-4 flex flex-col gap-4", children: [
      ...
      Array.isArray(promo_shorts) && promo_shorts.length > 0 && /* @__PURE__ */ jsxs("section", { className: "w-full min-w-0 max-w-full overflow-x-hidden", "aria-labelledby": "promos-heading", children: [
        /* @__PURE__ */ jsx("h2", { id: "promos-heading", className: "text-lg font-bold text-slate-900 px-4 flex items-center overflow-hidden", children: "Shorts" }),
        /* @__PURE__ */ jsx("div", { className: "min-w-0 w-full overflow-x-hidden", children: /* @__PURE__ */ jsx(
          Carousel,
          {
