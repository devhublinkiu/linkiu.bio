...
function Create() {
  ...
  const submit = (e) => {
    ...
    router.post(route("tenant.admin.devotionals.store", currentTenant?.slug), payload, {
      preserveScroll: true,
      onSuccess: () => toast.success("Devocional creado correctamente"),
      onError: (errs) => {
        setErrors(errs);
  ...
  return /* @__PURE__ */ jsxs(AdminLayout, { title: "Nuevo devocional", children: [
    /* @__PURE__ */ jsx(Head, { title: "Nuevo devocional" }),
    /* @__PURE__ */ jsx("div", { className: "max-w-2xl mx-auto", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm mt-1", children: "Título, versículo, reflexión, portada y opcionalmente video o enlace externo." })
      ] }),
      /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6 rounded-xl border bg-card p-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsx("p", { className: "text-xs text-muted-foreground", children: "Sube una imagen. Se usará como portada (cover). Máx. 2 MB." }),
          /* @__PURE__ */ jsx(
            Input,
            {
              id: "cover_image_file",
          ...
          coverPreview && /* @__PURE__ */ jsx("div", { className: "w-full max-w-[400px] aspect-[1200/630] rounded-lg border overflow-hidden bg-muted", children: /* @__PURE__ */ jsx("img", { src: coverPreview, alt: "Vista previa portada", className: "w-full h-full object-cover" }) }),
