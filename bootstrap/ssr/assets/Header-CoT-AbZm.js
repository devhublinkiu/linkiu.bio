...
import { A as AnimatedGradientText } from "./ReportBusinessStrip-U20bW72V.js";
function Header({ tenantName, description, logoUrl, bgColor, textColor, descriptionColor }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "w-full px-4 pt-2 pb-2 z-10 space-y-0", children: [
    selectedLocationName && shortsUrl && /* @__PURE__ */ jsxs(
      Link,
      {
        href: shortsUrl,
        className: "group relative mt-3 mb-3 flex w-full items-center justify-center rounded-[2rem] px-4 py-1 bg-white",
        children: [
          /* @__PURE__ */ jsx(
            "span",
            {
    ...
    /* @__PURE__ */ jsxs("div", { className: "w-full bg-white rounded-[1rem] overflow-hidden relative", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "bg-slate-100 py-3 sm:py-4 px-4", children: /* @__PURE__ */ jsx("nav", { className: "grid grid-cols-5 gap-4", "aria-label": "Navegación principal", children: menuItems.map((item) => {
        const isActive = activeTab === item.id;
        const isLink = item.href && item.href !== "#";
        const itemContent = /* @__PURE__ */ jsxs(
          "div",
          {
            className: `flex flex-col items-center justify-center gap-1 py-2 px-1 rounded-xl transition-all duration-300 ${isActive ? "bg-slate-900 w-24 px-3 text-white shadow-lg shadow-slate-900/20" : "text-slate-500"}`,
            children: [
              /* @__PURE__ */ jsx(item.icon, { className: "w-5 h-5 sm:w-6 sm:h-6 shrink-0", "aria-hidden": true }),
              /* @__PURE__ */ jsx("span", { className: `text-[14px] sm:text-xs font-semibold whitespace-nowrap leading-tight ${isActive ? "text-white" : "text-slate-600"}`, children: item.label })
            ]
          }
        );
