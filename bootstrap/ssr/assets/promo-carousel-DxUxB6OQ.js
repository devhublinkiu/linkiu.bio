...
const Carousel = ({ items, initialScroll = 0 }) => {
  ...
  return /* @__PURE__ */ jsx(CarouselContext.Provider, { value: { activeIndex }, children: /* @__PURE__ */ jsxs("div", { className: "relative w-full min-w-0 overflow-hidden", children: [
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsx("div", { className: cn("absolute right-0 top-0 bottom-0 z-[1000] w-[5%] overflow-hidden bg-gradient-to-l pointer-events-none") }),
          /* @__PURE__ */ jsx("div", { className: cn("flex flex-row justify-start gap-4", "max-w-7xl pl-[calc(50%-7rem)] md:pl-[calc(50%-12rem)]"), children: items.map((item, index) => /* @__PURE__ */ jsx(
            ObservedCard,
            {
              index,
              setActiveIndex,
...
const PromoCard = ({
  ...
  return /* @__PURE__ */ jsx(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxs("div", { className: "relative aspect-[9/16] w-full overflow-hidden bg-black rounded-t-lg", children: [
        /* @__PURE__ */ jsx(
          "iframe",
          {
            title: card.title,
        ...
        /* @__PURE__ */ jsxs("div", { className: "absolute inset-x-0 top-0 z-10 flex flex-col gap-2 bg-gradient-to-b from-black/70 to-transparent px-4 pt-4 pb-6", children: [
          /* @__PURE__ */ jsx(
            "h3",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center gap-1", children: [
            badgeLabel && /* @__PURE__ */ jsx("span", { className: "inline-flex rounded-lg bg-white/70 backdrop-blur-sm px-2 py-0.5 text-xs font-bold text-slate-900 border border-white/30", children: badgeLabel }),
