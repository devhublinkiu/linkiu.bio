  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100", children: /* @__PURE__ */ jsx("div", { className: "relative flex min-h-screen flex-col", children: /* @__PURE__ */ jsxs("div", { className: "relative w-full max-w-6xl px-6 lg:max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxs("header", { className: "flex items-center justify-between gap-4 py-6 lg:py-8", children: [
        /* @__PURE__ */ jsx(Link, { href: "/", className: "shrink-0", "aria-label": "Linkiu inicio", children: /* @__PURE__ */ jsx("img", { src: "/logo_nav_web_linkiu.svg", alt: "Linkiu", className: "h-8 w-auto dark:invert" }) }),
        /* @__PURE__ */ jsxs("nav", { className: "hidden md:flex flex-wrap items-center gap-1 lg:gap-2", children: [
          NAV_LINKS.map(({ href, label }) => /* @__PURE__ */ jsx(Link, { href, className: linkClass, children: label }, href)),
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex md:hidden items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxs(Sheet, { open: menuOpen, onOpenChange: setMenuOpen, children: [
            ...
            /* @__PURE__ */ jsx(SheetContent, { side: "right", className: "w-full max-w-xs flex flex-col gap-2 pt-10", children: NAV_LINKS.map(({ href, label }) => /* @__PURE__ */ jsx(Link, { href, className: linkClass, onClick: () => setMenuOpen(false), children: label }, href)) })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("section", { id: "inicio", className: "relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden py-16 sm:py-24 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "relative z-10", children: [
          /* @__PURE__ */ jsx("h1", { className: "text-6xl justify-start text-left md:text-center font-bold tracking-tight text-slate-900 dark:text-white md:text-7xl max-w-4xl mx-auto", children: "Tu negocio, un solo enlace" }),
          ...
          /* @__PURE__ */ jsx("div", { className: "relative w-full max-w-4xl mx-auto h-[480px] overflow-hidden rounded-lg -mt-32", children: /* @__PURE__ */ jsx(Spline, { scene: SPLINE_SCENE_URL, className: "size-full", style: { width: "100%", height: "100%" } }) })
        ] })
      ] }),
