...
import React__default, { useState, useContext, useRef, useEffect, useMemo } from "react";
...
function VerticalsAds$1({ className }) {
  return /* @__PURE__ */ jsxs(
    "div",
    {
...
function VerticalsAds({ className }) {
  const verticalSlug = usePage().props.currentTenant?.vertical?.slug;
