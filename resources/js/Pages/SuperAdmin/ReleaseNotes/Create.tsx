...
export default function Create({ categories }: Props) {
    ...
    return (
        <SuperAdminLayout header="Nuevo Release Note">
            <Head title="Nuevo Release Note" />
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Portada para la card; cuerpo en HTML (texto plano por ahora).</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                        <Button type="submit" disabled={processing}>Crear release note</Button>
