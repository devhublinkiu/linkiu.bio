...
export default function Edit({ collaborator }: Props) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        router.put(route('tenant.admin.collaborators.update', [currentTenant?.slug, collaborator.id]), payload as Record<string, string | number | boolean | File | null>, {
            preserveScroll: true,
    ...
    return (
        <AdminLayout title="Editar colaborador">
                ...
                <div className="space-y-6">
                    ...
                    <form onSubmit={submit} className="space-y-6 rounded-xl border bg-card p-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">Se usará como foto de perfil (cuadrada). Máx. 2 MB. Dejar vacío para mantener la actual.</p>
                            <Input
                                id="photo_file"
                                type="file"
                                accept="image/*"
                            ...
                            {displayPhoto && (
                                <div className="w-24 h-24 rounded-full border overflow-hidden bg-muted">
                                    <img src={displayPhoto} alt="Vista previa" className="w-full h-full object-cover" />
                                </div>
                            )}
