...
export default function Create() {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        router.post(route('tenant.admin.devotionals.store', currentTenant?.slug), payload as Record<string, string | number | boolean | File | null>, {
            preserveScroll: true,
    ...
    return (
        <AdminLayout title="Nuevo devocional">
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">
                            Título, versículo, reflexión, portada y opcionalmente video o enlace externo.
                        </p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6 rounded-xl border bg-card p-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">Sube una imagen. Se usará como portada (cover). Máx. 2 MB.</p>
                            <Input
                                id="cover_image_file"
                                type="file"
                                accept="image/*"
                            ...
                            {coverPreview && (
                                <div className="w-full max-w-[400px] aspect-[1200/630] rounded-lg border overflow-hidden bg-muted">
                                    <img src={coverPreview} alt="Vista previa portada" className="w-full h-full object-cover" />
                                </div>
                            )}
