...
export default function Create() {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        router.post(route('tenant.admin.services.store', currentTenant?.slug), payload as Record<string, string | number | boolean | File | null>, {
            preserveScroll: true,
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm mt-1">
                            Añade un culto, reunión o actividad que ofrece tu iglesia.
                        </p>
                    </div>
                    ...
                    <form onSubmit={submit} className="space-y-6 rounded-xl border bg-card p-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-xs text-muted-foreground">Se redimensionará a 200 × 120 px. Máx. 2 MB.</p>
                            <Input
                                id="image_file"
                                type="file"
                                accept="image/*"
