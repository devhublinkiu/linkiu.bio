        ...
        <section id="nosotros" className="relative z-10 overflow-hidden py-16 sm:py-24">
            ...
            <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
                <div className="grid gap-12 lg:grid-cols-2 lg:gap-16 lg:items-center">
                    {/* Columna izquierda: tarjetas tipo métricas */}
                    <div className="relative flex flex-col items-center justify-center min-h-[320px] sm:min-h-[380px]">
                        {/* Tarjeta principal */}
                        <div className="relative w-full max-w-[280px] rounded-2xl border border-slate-200 bg-white p-5 shadow-lg shadow-slate-200/50 dark:border-slate-700 dark:bg-slate-800/80 dark:shadow-slate-900/50">
                        ...
                        {/* Tarjeta secundaria (fondo) */}
                        <div className="absolute right-0 top-0 w-[260px] rounded-2xl border border-slate-200 bg-white p-4 shadow-md dark:border-slate-700 dark:bg-slate-800/60 sm:right-4 sm:top-4">
                        ...
                        {/* Mini tarjeta crecimiento */}
                        <div className="absolute bottom-8 left-0 rounded-xl border border-emerald-200 bg-white px-3 py-2 shadow-sm dark:border-emerald-800 dark:bg-slate-800/80 sm:left-4">
