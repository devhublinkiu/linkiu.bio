            ...
            <SidebarMenuItem>
                <DropdownMenu>
                    ...
                    >
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuGroup>
                            <DropdownMenuItem asChild className="cursor-pointer outline-none ring-0 focus:ring-0 focus:outline-none">
                                <a href="/superlinkiu/profile">
                                    <BadgeCheck />
                                    Perfil
                                </a>
                            </DropdownMenuItem>
                            <DropdownMenuItem asChild className="cursor-pointer outline-none ring-0 focus:ring-0 focus:outline-none">
                                <a href="/superlinkiu/settings">
                                    <Settings2 />
                                    Configuración
                                </a>
                            </DropdownMenuItem>
